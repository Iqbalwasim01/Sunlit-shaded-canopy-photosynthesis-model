...
Kc<-10.8    # enter Kc field from dataframe or enter manually here
...
LMA<-0.087 # chosen plant functional type leaf mass area for C3 species
Sensor.height<-2.7 # (meters) example: change to match site flux tower height (Reported in site detail files)
